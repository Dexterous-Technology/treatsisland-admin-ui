...
const PopupStore = ({
  ...
  return (
    <>
      {/* **************************************** MODALS - POPUP STORE */}
        <div className={"modalPopupStores " + (eventVisiblePopupStore ? "show" : "")}>
            {/* ALL POPUP STORES */}
            <div className={"allPopupStores " + (modalAllPopupStore ? "d-block" : "d-none")}>
                <div className="modalTop" onClick={onPopupStoreModalDismiss}><i className="fa fa-arrow-left"></i> <span>Go back</span></div>
